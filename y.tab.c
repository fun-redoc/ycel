...
#line 86 "ycel.y"
  ...
  case 16:
#line 87 "ycel.y"
    {(yyval.nPtr)=mk_node((TRef){row_num, col_num},OPR(AVG), TypeAvg,1,(yyvsp[(3) - (4)].nPtr));DO(update_node_into_table(ch, row_num, col_num, (yyval.nPtr)));}
    break;
